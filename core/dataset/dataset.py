...
class CenterNetDataset(Dataset):
    ...
    def debug_sparse_infos(self,index):
        ...
        for i in range(len(labels)):
            ...
            if h > 0 and w > 0:
                ...
                # Assign ground truth height and width: cw,ch,w,h
                bbox_center_wh.append([ct_int[0],ct_int[1],w,h])

                # Assign center point offset
                # Assign center point offset
                batch_offset[ct_int[1], ct_int[0]] = ct - ct_int

        return batch_hm,bbox_center_wh,batch_offset
